# ⚙️ JavaScript Interaction Guide

This project uses JavaScript to handle user interaction, data storage, and page navigation.
...
## 📂 Sidebar State Management (边栏状态管理)

Controls UI state and stores user preference.
(控制用户界面状态并存储用户首选项。)
```js
